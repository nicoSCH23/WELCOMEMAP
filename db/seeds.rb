services = [[["showers"], { hours: "", activities: "", price: "", appointment: false} { name: 'Douches Jaures', address: "56 rue de Meaux, 75019 Paris", phone:"0650166564", comment: "Open all year round and free" }],
    [["showers"], { hours: "", activities: "", price: "", appointment: false} { name: 'BainsGratuit', address: "17 Rue Blomet, 75015 Paris", phone: "0650166564", comment: "Open all year round and free" }],
    [['legal','showers'], { hours: "", activities: "", price: "", appointment: false} { name: 'InfoMigrants', address: "9 square de Port-Royal, 75013 Paris", phone: "0650166564", comment: "Open all year round and free" }],
    [["clothes"], { hours: "", activities: "", price: "", appointment: false} { name: 'ClothMigrants', address: "1 Parvis Notre-Dame - Pl. Jean-Paul II, 75004 Paris", phone: "0650166564", comment: "Open all year round and free" }],
    [["clothes"], { hours: "", activities: "", price: "", appointment: false} { name: 'ClothRestauduCoeur', address: "42 Rue de Clichy, 75009 Paris", phone: "0650166564", comment: "Open all year round and free" }],
    [["food", "clothes"], { hours: "", activities: "", price: "", appointment: false} { name: 'FooMigrants', address: "9 rue Edouard-Jacques, 75014 Paris", phone: "0650166564", comment: "Open all year round and free" }]
]
